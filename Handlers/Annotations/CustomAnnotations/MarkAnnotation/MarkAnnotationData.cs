...
{
    /// <summary>
    /// Holds information about the annotation that displays a mark.
    /// </summary>
    public class MarkAnnotationData : AnnotationData
    {
        ...
        /// <summary>
        /// Gets or sets a mark annotationType.
        /// </summary>
        ...
        /// size and rotation.
        /// </summary>
        /// <param name="location">Location, in device-independent units (1/96th inch per unit),
        /// of annotation.</param>
        /// <param name="size">Size, in device-independent units (1/96th inch per unit),
        /// of annotation</param>
        /// <param name="rotationAngle">Rotation, in degrees, of annotation.</param>
        /// <returns>Bounding box of annotation.</returns>
        public override RectangleF GetBoundingBox(PointF location, SizeF size, float rotationAngle)
        {
