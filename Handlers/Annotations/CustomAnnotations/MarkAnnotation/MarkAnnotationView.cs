...
{
    /// <summary>
    /// Determines how to display the annotation that displays a mark
    /// and how user can interact with annotation.
    /// </summary>
    /// <remarks>
    /// <b>Important:</b> This class is necessary for annotation burning only.
    /// </remarks>
    public class MarkAnnotationView: AnnotationView, IRectangularInteractiveObject
    {
        ...
        public MarkAnnotationView(MarkAnnotationData annotationData)
            : base(annotationData)
        {
            SizeF initalSize = Size;
            if (initalSize.IsEmpty)
            {
                initalSize = new Size(64, 64);
                Size = initalSize;
            }
